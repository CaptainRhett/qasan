...
def run_example_tool(bat_file):
	...
	command = "/home/wuhuang/fuzz/qasan/qasan-qemu -L /home/wuhuang/fuzz/qasan/cramfs-root -E LD_PRELOAD=/home/wuhuang/fuzz/qasan/libqasan/libqasan.so " + bat_file
...
if __name__ == '__main__':
	...
	py_common.run_analysis("./testcase", "CWE.*\.out")
